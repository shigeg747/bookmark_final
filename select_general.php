    ...
    <header>
      <nav class="navbar navbar-default">
        <div class="container-fluid" style="position:relative;">
          ...
          <a class="navbar-brand aaa" href="index.html">ログイン</a>
          <a class="navbar-brand aaa" href="login_reg.html">ユーザー登録</a>
          <p style="color:black;">←ユーザー登録をすると自分オリジナルのカスタマイズページが作れます。</p>
          <p class="name"  style="position:absolute; right:10px; color:black;">ゲスト様</p>
          </div>
        </div>
      </nav>
    </header>
