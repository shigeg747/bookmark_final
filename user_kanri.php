...
if($status==false) {
  ...
  $view = "";
    ...
    foreach ($result as $row) {
      ...
      if($kanri == 0){
        $view .= "<td class='list_item'>無料会員</td>";
      } else {
        $view .= "<td class='list_item'>有料会員</td>";
      }
      if($life == 0){
        $view .= "<td class='list_item'>継続中</td>";
      } else {
        $view .= "<td class='list_item'>退会済</td>";
      }
      ...
      $view .= '</a>'."</td>";
      $view .= "<td class='list_item'>";
      $view .= '<a class="aaa" href="user_delete.php?id='.$row['id'].'">';
      $view .= '削除';
      $view .= '</a>'."</td>";
      $view .= "</tr>";
    }
...
<main class="main">
  <div class="container">
      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid" style="position:relative;">
          <div class="navbar-header">
            ...
            <a class="navbar-brand aaa" href="index.html">ログインへ</a>
    ...
    <table class="table">
      <thead>
        <tr>
          <th class="txcenter">お名前</th>
          <th class="txcenter">Id</th>
          <th class="txcenter">パスワード</th>
          <th class="txcenter">ステータス</th>
          <th class="txcenter">状態</th>
